...
public abstract class PasswordAttributeTest extends LomTestCase {
	...
	public void validConfigurationForPasswordAttributeType() {
		...
		createAndVerifyOneAttribute("abc.a", 1, "pa", PASSWORD,
				"{\"minlength\":10}");

		createAndVerifyOneAttribute("abc.a", 1, "pb", PASSWORD,
				"{\"maxlength\":100000}");

		createAndVerifyOneAttribute("abc.a", 1, "pc", PASSWORD,
				"{\"maxlength\":100000}");

		createAndVerifyOneAttribute("abc.a", 1, "pd", PASSWORD,
				"{\"minUppers\":1}");

		createAndVerifyOneAttribute("abc.a", 1, "pe", PASSWORD,
				"{\"minNumbers\":2}");

		createAndVerifyOneAttribute("abc.a", 1, "pf", PASSWORD,
				"{\"minSymbols\":3}");

		createAndVerifyOneAttribute("abc.a", 1, "pg", PASSWORD,
				"{\"maxRepeat\":2}");
		...
		createAndVerifyOneAttribute("abc.a", 1, "pj", PASSWORD,
				"{\"default\":\"Abcdef\", \"minUppers\":1}");

		createAndVerifyOneAttribute("abc.a", 1, "pk", PASSWORD,
				"{\"default\":\"abcdef10\", \"minNumbers\":2}");

		createAndVerifyOneAttribute("abc.a", 1, "pl", PASSWORD,
				"{\"default\":\"abcdef!@#\", \"minSymbols\":3}");

		createAndVerifyOneAttribute("abc.a", 1, "pm", PASSWORD,
	...
	public void validChangeConfigurationForPasswordAttributeType() {
		...
		Attribute updatedAttribute12 = updateAttribute("abc.a",
				updatedAttribute11, 1, "pa", PASSWORD,
				PASSWORD_CONFIGURATION_COMPLETE);
		verifyUpdatedAttribute(updatedAttribute11, updatedAttribute12);

		Attribute updatedAttribute21 = updateAttribute("abc.a",
				createdAttribute2, 2, "pb", PASSWORD,
				PASSWORD_CONFIGURATION_PARTIAL);
		verifyUpdatedAttribute(createdAttribute2, updatedAttribute21);

		Attribute updatedAttribute22 = updateAttribute("abc.a",
				updatedAttribute21, 2, "pb", PASSWORD, MANDATORY_TRUE);
		verifyUpdatedAttribute(updatedAttribute21, updatedAttribute22);

		Attribute updatedAttribute23 = updateAttribute("abc.a",
				updatedAttribute22, 2, "pb", PASSWORD, "{\"default\":\"abc\"}");
		verifyUpdatedAttribute(updatedAttribute22, updatedAttribute23);

		Attribute updatedAttribute24 = updateAttribute("abc.a",
				updatedAttribute23, 2, "pb", PASSWORD, "{\"default\":\"123\"}");
