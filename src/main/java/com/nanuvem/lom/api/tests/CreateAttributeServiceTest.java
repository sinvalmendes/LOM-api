...
import static com.nanuvem.lom.api.tests.AttributeHelper.*;

public abstract class CreateAttributeServiceTest {
	...
	public void invalidAttributeData() {
		...
		expectExceptionOnCreateInvalidAttribute(facade, "abc.a", -1, "pa",
				AttributeType.TEXT, "{\"mandatory\":true}",
				"Invalid value for Attribute sequence: -1");

		expectExceptionOnCreateInvalidAttribute(facade, "abc.a", 2, "pa",
				AttributeType.TEXT, "{\"mandatory\":true}",
		...
		expectExceptionOnCreateInvalidAttribute(facade, "abc.a", 1, "pa", null,
	...
	public void invalidAttributeName() {
		...
		expectExceptionOnCreateInvalidAttribute(facade, "abc.a", 1, "aaa.a",
				AttributeType.TEXT, "{\"mandatory\":true}",
	...
	public void validateSeveralAttributesInTheSameEntity() {
		...
		createAndVerifyOneAttribute(facade, "abc.a", null, "pb",
				AttributeType.LONGTEXT, "");
		Assert.assertEquals(new Integer(2), this.facade
		...
		createAndVerifyOneAttribute(facade, "b", new Integer(1), "pa",
				AttributeType.LONGTEXT, "");
		createAndVerifyOneAttribute(facade, "b", new Integer(1), "pb",
				AttributeType.LONGTEXT, "");
		Assert.assertEquals(new Integer(2), this.facade
		...
		createAndVerifyOneAttribute(facade, "c", new Integer(1), "pa",
				AttributeType.TEXT, "");
		createAndVerifyOneAttribute(facade, "c", new Integer(2), "pb",
				AttributeType.LONGTEXT, "");
		createAndVerifyOneAttribute(facade, "c", new Integer(2), "pc",
				AttributeType.LONGTEXT, "");
		Assert.assertEquals(new Integer(1), this.facade
				.findAttributeByNameAndEntityFullName("pa", "c").getSequence());
		Assert.assertEquals(new Integer(3), this.facade
	...
	public void validateAttributeDuplicationInTheSameEntity() {
		...
		expectExceptionOnCreateInvalidAttribute(facade, "abc.a", null, "pa",
				AttributeType.LONGTEXT, "",
	...
	public void invalidEntity() {
		...
		expectExceptionOnCreateInvalidAttribute(facade, "abc.b", null,
				"abc123", null, "", "Entity not found: abc.b");
	}
	...
	public void validateConfigurationForTextAttributeType() {
		...
		createAndVerifyOneAttribute(facade, "abc.a", 1, "pb",
				AttributeType.TEXT, "{\"minlength\":10}");

		createAndVerifyOneAttribute(facade, "abc.a", 1, "pc",
		...
		createAndVerifyOneAttribute(facade, "abc.a", 1, "pe",
				AttributeType.TEXT, "");
		...
		createAndVerifyOneAttribute(facade, "abc.a", 1, "pg",
	...
	public void invalidConfigurationForTextAttributeType() {
		...
		// expectExceptionOnCreateInvalidAttribute(facade,
		// "abc.a",
		// null,
		// "pa",
		// AttributeType.TEXT,
	...
	public void validConfigurationForLongTextAttributeType() {
		...
		createAndVerifyOneAttribute(facade, "abc.a", 1, "p2",
		...
		createAndVerifyOneAttribute(facade, "abc.a", 1, "p4",
				AttributeType.LONGTEXT, "");
	}
	...
	public void invalidConfigurationForLongTextAttributeType() {
		...
		AttributeHelper
				.expectExceptionOnCreateInvalidAttribute(facade, "abc.a", 1,
						"pa", AttributeType.LONGTEXT, "{\"default\":10}",
						"Invalid configuration for attribute pa: the default value must be a string");
	...
	public void validConfigurationForPasswordAttributeType() {
		...
		createAndVerifyOneAttribute(facade, "abc.a", 1, "pd",
				AttributeType.PASSWORD, "{\"minUppers\":1}");

		createAndVerifyOneAttribute(facade, "abc.a", 1, "pe",
				AttributeType.PASSWORD, "{\"minNumbers\":2}");

		createAndVerifyOneAttribute(facade, "abc.a", 1, "pf",
		...
		createAndVerifyOneAttribute(facade, "abc.a", 1, "pi",
				AttributeType.PASSWORD, "");
		createAndVerifyOneAttribute(facade, "abc.a", 1, "pj",
				AttributeType.PASSWORD,
				"{\"default\":\"Abcdef\", \"minUppers\":1}");

		createAndVerifyOneAttribute(facade, "abc.a", 1, "pk",
				AttributeType.PASSWORD,
				"{\"default\":\"abcdef10\", \"minNumbers\":2}");

		createAndVerifyOneAttribute(facade, "abc.a", 1, "pl",
				AttributeType.PASSWORD,
				"{\"default\":\"abcdef!@#\", \"minSymbols\":3}");

		createAndVerifyOneAttribute(facade, "abc.a", 1, "pm",
				AttributeType.PASSWORD,
	...
	public void invalidConfigurationForPasswordAttributeType() {
		...
		AttributeHelper
				.expectExceptionOnCreateInvalidAttribute(facade, "abc.a", 1,
						"pa", AttributeType.PASSWORD, "{\"default\":10}",
						"Invalid configuration for attribute pa: the default value must be a string");
	...
	public void validConfigurationForIntegerAttributeType() {
		...
		AttributeHelper
				.createAndVerifyOneAttribute(facade, "abc.a", 1, "p3",
	...
	public void invalidConfigurationForIntegerAttributeType() {
		...
		expectExceptionOnCreateInvalidAttribute(facade, "abc.a", null, "pa",
				AttributeType.INTEGER, "{\"minvalue\":50, \"maxvalue\":10}",
	...
	public void invalidConfigurationForObjectAttributeType() {
		...
		AttributeHelper
				.expectExceptionOnCreateInvalidAttribute(facade, "abc.a", null,
						"pa", AttributeType.OBJECT, "{\"default\":10}",
						"Invalid configuration for attribute pa: the default value must be a string");
