...
public abstract class LongTextAttributeTest extends LomTestCase {
	...
	public void validConfigurationForLongTextAttributeType() {
		...
		createAndVerifyOneAttribute("abc.a", 1, "p1", LONGTEXT,
				"{\"minlength\":10}");

		createAndVerifyOneAttribute("abc.a", 1, "p2", LONGTEXT,
				"{\"maxlength\":100000}");
	...
	public void validChangeConfigurationForLongTextAttributeType() {
		...
		Attribute updatedAttribute12 = updateAttribute("abc.a",
				updatedAttribute11, 1, "pa", LONGTEXT,
