...
public abstract class TextAttributeTest extends LomTestCase {
	...
	public void validateConfigurationForTextAttributeType() {
		...
		createAndVerifyOneAttribute("abc.a", 1, "pb", TEXT,
				"{\"minlength\":10}");

		createAndVerifyOneAttribute("abc.a", 1, "pc", TEXT,
				"{\"minlength\":100}");
		...
		createAndVerifyOneAttribute("abc.a", 1, "pg", TEXT,
				"{\"default\":\"abc\"}");
