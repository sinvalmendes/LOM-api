...
public abstract class UpdateEntityTest extends LomTestCase {
	...
	public void newNameAndPackageWithSpaces() {
		Entity ea = createAndSaveOneEntity("a", "aaa");
		expectExceptionOnInvalidEntityUpdate(ea, "name space", "aaa",
				INVALID_VALUE_FOR_ENTITY, "namespace", "name space");
		expectExceptionOnInvalidEntityUpdate(ea, "namespace", "na me",
				INVALID_VALUE_FOR_ENTITY, "name", "na me");
	}

	@Test
	public void removeName() {
		Entity ea = createAndSaveOneEntity("a", "aaa");
		expectExceptionOnInvalidEntityUpdate(ea, "namespace", null,
				ENTITY_NAME_IS_MANDATORY);
		expectExceptionOnInvalidEntityUpdate(ea, "namespace", "",
				ENTITY_NAME_IS_MANDATORY);
		expectExceptionOnInvalidEntityUpdate(ea, null, null,
				ENTITY_NAME_IS_MANDATORY);
		expectExceptionOnInvalidEntityUpdate(ea, null, "",
				ENTITY_NAME_IS_MANDATORY);
	}
	...
	public void renameMoveCausingTwoEntitiesWithSameNameInDefaultPackage() {
		...
		expectExceptionOnInvalidEntityUpdate(ea, "b", "bbb",
				ENTITY_ALREADY_EXISTS, "b.bbb");
		expectExceptionOnInvalidEntityUpdate(ea, "b", "aaa",
				ENTITY_ALREADY_EXISTS, "b.aaa");
		expectExceptionOnInvalidEntityUpdate(ea, "a", "bbb",
				ENTITY_ALREADY_EXISTS, "a.bbb");
		...
		expectExceptionOnInvalidEntityUpdate(e1, "b.c", "bbb",
				ENTITY_ALREADY_EXISTS, "b.c.bbb");
		expectExceptionOnInvalidEntityUpdate(e2, "b.c", "bbb",
				ENTITY_ALREADY_EXISTS, "b.c.bbb");
		expectExceptionOnInvalidEntityUpdate(e3, "b.c", "bbb",
				ENTITY_ALREADY_EXISTS, "b.c.bbb");
	}
	...
	public void renameMoveCausingTwoEntitiesWithSameNameInAnonDefaultPackage() {
		...
		expectExceptionOnInvalidEntityUpdate(ea1, null, "bbb",
				ENTITY_ALREADY_EXISTS, "bbb");
		expectExceptionOnInvalidEntityUpdate(ea2, null, "bbb",
				ENTITY_ALREADY_EXISTS, "bbb");
		expectExceptionOnInvalidEntityUpdate(ea3, null, "bbb",
				ENTITY_ALREADY_EXISTS, "bbb");
		...
		expectExceptionOnInvalidEntityUpdate(ec1, "", "ddd",
				ENTITY_ALREADY_EXISTS, "ddd");
		expectExceptionOnInvalidEntityUpdate(ec2, "", "ddd",
				ENTITY_ALREADY_EXISTS, "ddd");
		expectExceptionOnInvalidEntityUpdate(ec3, "", "ddd",
				ENTITY_ALREADY_EXISTS, "ddd");
	}
	...
	public void renameMoveCausingNameAndPackagesWithInvalidChars() {
		...
		expectExceptionOnInvalidEntityUpdate(ea, "a", "aaa$",
				INVALID_VALUE_FOR_ENTITY, "name", "aaa$");
		expectExceptionOnInvalidEntityUpdate(ea, "a", "aaa#",
				INVALID_VALUE_FOR_ENTITY, "name", "aaa#");
		expectExceptionOnInvalidEntityUpdate(ea, "a", "aaa=",
				INVALID_VALUE_FOR_ENTITY, "name", "aaa=");
		expectExceptionOnInvalidEntityUpdate(ea, "a", "aaa'",
				INVALID_VALUE_FOR_ENTITY, "name", "aaa'");
		expectExceptionOnInvalidEntityUpdate(ea, "a", "aaa.a",
				INVALID_VALUE_FOR_ENTITY, "name", "aaa.a");
		expectExceptionOnInvalidEntityUpdate(ea, "a", "aaa/a",
				INVALID_VALUE_FOR_ENTITY, "name", "aaa/a");
		expectExceptionOnInvalidEntityUpdate(ea, "a", "aaa*",
				INVALID_VALUE_FOR_ENTITY, "name", "aaa*");
		...
		// expectExceptionOnInvalidEntityUpdate(ea, "a.", "aaa",
		// INVALID_VALUE_FOR_ENTITY, "namespace", "a.");
		expectExceptionOnInvalidEntityUpdate(ea, "a/a", "aaa",
				INVALID_VALUE_FOR_ENTITY, "namespace", "a/a");
		expectExceptionOnInvalidEntityUpdate(ea, "a*", "aaa",
				INVALID_VALUE_FOR_ENTITY, "namespace", "a*");
	}
	...
	public void renameMoveForcingCaseInsentivePackagesAndNames() {
		...
		expectExceptionOnInvalidEntityUpdate(ea, "b", "BBB",
				ENTITY_ALREADY_EXISTS, "b.bbb");
		expectExceptionOnInvalidEntityUpdate(ea, "ccc", "ccc",
				ENTITY_ALREADY_EXISTS, "ccc.ccc");
		expectExceptionOnInvalidEntityUpdate(ea, "CCC", "ccc",
				ENTITY_ALREADY_EXISTS, "ccc.ccc");
		expectExceptionOnInvalidEntityUpdate(ea, "ddd", "ddd",
				ENTITY_ALREADY_EXISTS, "ddd.ddd");
		expectExceptionOnInvalidEntityUpdate(ea, "ddd", "DDD",
				ENTITY_ALREADY_EXISTS, "ddd.ddd");
	}
	...
	public void invalidIdAndVersion() {
		...
		expectExceptionOnInvalidEntityUpdate(ea, "namespace", "name",
				"Invalid id for Entity namespace.name");
		...
		expectExceptionOnInvalidEntityUpdate(
				...
				"namespace",
				"name",
				"Updating a deprecated version of Entity a.aaa. "
