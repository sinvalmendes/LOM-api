...
public class AttributeHelper {
	...
	public static Attribute createOneAttribute(String entityFullName,
	...
	public static void expectExceptionOnCreateInvalidAttribute(
			...
			String attributeConfiguration, String expectedMessage,
			String... args) {
	...
	public static void createAndVerifyOneAttribute(String entityFullName,
			Integer attributeSequence, String attributeName,
			AttributeType attributeType, String attributeConfiguration) {

		Attribute createdAttribute = createOneAttribute(entityFullName,
	...
	public static Attribute updateAttribute(String fullEntityName,
			Attribute oldAttribute, Integer newSequence, String newName,
			AttributeType newType, String newConfiguration) {

		Attribute attribute = facade.findAttributeByNameAndEntityFullName(
				oldAttribute.getName(), fullEntityName);
	...
	public static void expectExceptionOnUpdateInvalidAttribute(
			String entityFullName, Attribute oldAttribute, Integer newSequence,
			String newName, AttributeType newType, String newConfiguration,
			String exceptedMessage) {

		try {
			updateAttribute(entityFullName, oldAttribute, newSequence, newName,
					newType, newConfiguration);
			fail();
	...
	public static void expectExceptionOnUpdateWithInvalidNewName(
		...
		expectExceptionOnUpdateInvalidAttribute("abc.a", createdAttribute, 1,
				invalidNewName, LONGTEXT, null, exceptedMessage);
	}

	public static void verifyUpdatedAttribute(Attribute attributeBeforeUpgrade,
