...
public abstract class CreateEntityTest extends LomTestCase {
	...
	public void nameAndNamespaceWithSpaces() {
		expectExceptionOnCreateInvalidEntity("name space", "name",
				INVALID_VALUE_FOR_ENTITY, "namespace", "name space");
		expectExceptionOnCreateInvalidEntity("namespace", "na me",
				INVALID_VALUE_FOR_ENTITY, "name", "na me");
	}

	@Test
	public void withoutName() {
		expectExceptionOnCreateInvalidEntity("namespace", null,
				ENTITY_NAME_IS_MANDATORY);
		expectExceptionOnCreateInvalidEntity("namespace", "",
				ENTITY_NAME_IS_MANDATORY);
		expectExceptionOnCreateInvalidEntity(null, null,
				ENTITY_NAME_IS_MANDATORY);
	...
	public void twoEntitiesWithSameNameInDefaultNamespace() {
		...
		expectExceptionOnCreateInvalidEntity(null, "aaa",
				ENTITY_ALREADY_EXISTS, "aaa");
		expectExceptionOnCreateInvalidEntity("", "aaa", ENTITY_ALREADY_EXISTS,
				"aaa");
	}
	...
	public void twoEntitiesWithSameNameInAnonDefaultNamespace() {
		...
		expectExceptionOnCreateInvalidEntity("a", "aaa", ENTITY_ALREADY_EXISTS,
				"a.aaa");
	}

	@Test
	public void nameAndNamespaceWithInvalidChars() {
		expectExceptionOnCreateInvalidEntity("a", "aaa$",
				INVALID_VALUE_FOR_ENTITY, "name", "aaa$");
		expectExceptionOnCreateInvalidEntity("a", "aaa#",
				INVALID_VALUE_FOR_ENTITY, "name", "aaa#");
		expectExceptionOnCreateInvalidEntity("a", "aaa=",
				INVALID_VALUE_FOR_ENTITY, "name", "aaa=");
		expectExceptionOnCreateInvalidEntity("a", "aaa.a",
		...
		expectExceptionOnCreateInvalidEntity("a/a", "aaa",
